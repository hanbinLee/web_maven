...
<head>
	...
	<title>게시판 수정</title>
	<script type="text/javascript" src="${root }/css/fileBoard/script.js"></script>
	<link rel="stylesheet" type="text/css" href="${root }/css/fileBoard/style.css"/>
</head>
<body>
	
	<form action="${root}/fileBoard/update.do" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
		...
		<c:if test="${board.fileName==null || board.fileName.equals('') }">
			<div class="line">
				<label class="title">파일명</label>
				<span class="content">
					<input type="file" name="file"/>
